...
var hsimsg =''
if(config.LANG === 'SI') hsimsg = 'ISHAN-X MD උපකාර මධ්‍යස්ථානය විවෘත්ත කරන්න'
else hsimsg = "Open ISHAN-X MD Help Center"
...
cmd({
  ...
  try {
    ...
    const caption = `_👋 Welcome to ISHAN-X MD Help Center!_ 💬
...
cmd({
  ...
  try {
    ...
    const step1 = `👋 ISHAN-X MD Help Center වෙත සාදරයෙන් පිළිගනිමු! 💬
...
cmd({
  ...
  try {
    ...
    const step1 = `👋 Welcome to the ISHAN-X MD Help Center! 💬
...
🚩 [  ISHAN-X MD Beta Bot - නිතර අසන ප්‍රශ්න ] 🚩

*➤ 1️⃣ISHAN-X MD Beta Bot යනු කුමක්ද?*
ISHAN-X MD Beta BOT යනු කෙනෙක් වන ඉෂාන් මදුශංක විසින් නිර්මාණය කරනු ලැබු WhatsApp බොට් එකකි.
...
🚩 [ ISHAN-X MD Beta Bot – Frequently Asked Questions ] 🚩

*➤ 1️⃣ What is ISHAN-X MD Beta Bot?*
Shala MD Beta Bot is a WhatsApp bot created by a developer named ishan madusanke.
